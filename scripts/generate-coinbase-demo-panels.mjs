...
const capabilityPanels = [
  {
    ...
    titleLines: ["No credential required"],
    accent: "#0052ff",
    items: [
      ["Default", "Protected dry run with labeled facts"],
      ["Optional", "View-only account + product + BBO + Preview"],
      ["Supported", "Spot BUY / SELL on exact held funds"],
      ["User job", "Say what trade you want"],
      ["Boundary", "Create unavailable · no order"],
    ],
    footer: "PROTECTION STARTS BEFORE ANY COINBASE REQUEST",
    modeLabel: "DRY RUN DEFAULT · OPTIONAL VIEW ONLY · NO LIVE ORDER",
  },
  {
    id: "02",
    duration: 18,
    eyebrow: "MANDATE CAPTURED",
    title: "The user sees every boundary",
    titleLines: ["The user sees", "every boundary"],
    accent: "#0052ff",
    items: [
      ["Action", "BUY up to 3,000 USDC · ETH-USDC"],
      ["Condition", "fresh best ask ≤ 3,000 USDC"],
      ["Execution", "IOC · partial fills · ≤35 bps"],
      ["Economics", "≤15 fee · ≤3,015 all-in"],
      ["Funding / use", "held USDC · no conversion · one use"],
      ["Authorization", "User replies “Authorize this mandate”"],
    ],
    footer: "HASH AND PLAN PATH STAY INTERNAL · THE USER REVIEWS PLAIN ENGLISH",
    modeLabel: "MANDATE DRAFT · NOT YET AUTHORIZED · NO ORDER",
  },
  {
    id: "03",
    duration: 18,
    eyebrow: "EXACT PROPOSAL",
    title: "Typed data crosses the guard",
    titleLines: ["Typed data crosses", "the guard"],
    accent: "#067647",
    items: [
      ["Model", "Extracts, clarifies, explains"],
      ["Guard", "Schema · decimals · policy · freshness"],
      ["Proposal", "ETH-USDC BUY · quote_size · IOC limit"],
      ["Evidence", "Balance · product · BBO · Preview"],
      ["Decision", "PASS / BLOCK / REVIEW with one reason"],
    ],
    footer: "THE MODEL DOES NOT OWN THE POLICY DECISION OR RELEASE GATE",
    modeLabel: "DETERMINISTIC GUARD · EXACT PAYLOAD · NO ORDER",
  },
  {
    id: "04",
    duration: 18,
    eyebrow: "PASS WITH CONTEXT",
    title: "Protection is readable",
    titleLines: ["Protection is readable"],
    accent: "#7a5af8",
    items: [
      ["Mandate", "Complete human boundary"],
      ["Proposal", "Rounded exact economics"],
      ["Reason", "Why it passed, blocked, or needs review"],
      ["Checked", "Source facts + timestamp / age"],
      ["Recovery", "One clear next action"],
    ],
    footer: "RAW HASHES AND METADATA APPEAR ONLY ON REQUEST",
    modeLabel: "COMPACT CHAT RESULT · SIMULATED FACTS · NO ORDER",
  },
  {
    id: "05",
    duration: 18,
    eyebrow: "RECEIPT + HISTORY",
    title: "Exact and locally verifiable",
    titleLines: ["Exact and locally", "verifiable"],
    accent: "#067647",
    items: [
      ["Receipt", "Policy + proposal + evidence + decision"],
      ["Bytes", "Preview request + prospective Create payload"],
      ["Replay", "Exact nonce only · semantic mismatch blocks"],
      ["Currentness", "Expiry + supersession are visible"],
      ["History", "Private · redacted · bounded · deletable"],
    ],
    footer: "LOCAL SHA-256 INTEGRITY · NOT A DELTA OR COINBASE SIGNATURE",
    modeLabel: "LOCAL RECEIPT · PRIVATE HISTORY · NO ORDER",
  },
  {
    id: "06",
    duration: 15,
    eyebrow: "EXECUTION BOUNDARY",
    title: "Preview never becomes Create",
    titleLines: ["Preview never", "becomes Create"],
    accent: "#b42318",
    items: [
      ["Dry run", "Local Delta simulation · no network"],
      ["View only", "Point-in-time facts · not Delta authorization"],
      ["BLOCK", "Verified mandate violation"],
      ["REVIEW", "Unable to verify · refresh / repair"],
      ["Create", "No route · no method · compile-time lock"],
    ],
    footer: "NO EXECUTION GRANT · NO ORDER · NO MONEY MOVED",
    modeLabel: "DRY RUN OR VIEW ONLY · CREATE UNAVAILABLE",
  },
];
...
<text x="54" y="224" fill="#667085" font-family="Inter,Arial,sans-serif" font-size="14" font-weight="800" letter-spacing="1">${escapeXml(panel.modeLabel ?? "SIMULATION ONLY · FIXTURE DATA · NO LIVE ORDER")}</text>
